...
00000000 &lt _start &gt:<br>
   0:	&nbspbf 00 00 00 00       	mov    $0x0,%edi<br>
   5:	&nbsp8b 04 bd 00 00 00 00 	mov    0x0(,%edi,4),%eax<br>
   c:	&nbsp89 c3 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp mov    %eax,%ebx<br>
<br>
0000000e  &lt start_loop &gt:<br>
   e:	&nbsp83 f8 00 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp cmp    $0x0,%eax<br>
